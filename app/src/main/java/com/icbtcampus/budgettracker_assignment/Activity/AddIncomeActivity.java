...
public class AddIncomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!NetworkUtil.isConnected(this)) {
            ...
            Intent intent = new Intent(AddIncomeActivity.this, NoInternetActivity.class);
        ...
        // Initialize Spinners
        incomeCategoryAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, incomeCategories);
        incomeCategoryAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerIncomeCategory.setAdapter(incomeCategoryAdapter);
    ...
    private void fetchCategoriesAndAccounts() {
        ...
        Uri.Builder uriBuilder = Uri.parse(baseUrl).buildUpon()
                .appendQueryParameter("category_type", "income");
                    ...
                    try {
                        ...
                        if (jsonResponse.getString("status").equals("success")) {
                            ...
                            for (int i = 0; i < categoriesArray.length(); i++) {
                                ...
                                incomeCategories.add(category.getString("category_name"));
    ...
    private int getSelectedCategoryId() {
        String selectedCategory = spinnerIncomeCategory.getSelectedItem().toString();
    ...
    private void sendPostRequest(String email, String apiKey, int accountId, int categoryId, double amount, String description) {
        ...
        try {
            ...
            postData.put("transaction_type", "income");
