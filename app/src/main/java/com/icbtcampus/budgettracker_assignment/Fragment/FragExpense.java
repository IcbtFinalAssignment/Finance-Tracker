...
public class FragExpense extends Fragment {

    TextView txtMonthName, txtNoFound, txtTotalExpense;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setupRecyclerView();
        txtTotalExpense.setText("Loading...");
        ...
        swipeRefreshExpense.setOnRefreshListener(() -> new Handler().postDelayed(() -> {
    ...
    private void setupRecyclerView() {
        ...
        rvExpenselist.setAdapter(transactionAdapter);
    }
    public void getTotalBalance(int month) {
        ...
        String url = GET_RECORDS + "?email=" + email + "&api_key=" + apiKey + "&transaction_type=expense&month=" + month;
                        ...
                        if (response.getString("status").equals("success")) {
                            ...
                            if (transactions.length() > 0) {
                                for (int i = 0; i < transactions.length(); i++) {
                                    ...
                                    sarvaloExpense += amount;
                                }
                                // Notify the adapter that data has changed
                                transactionAdapter.notifyDataSetChanged();
                                // Update the total income text view
                                txtTotalExpense.setText(String.format("%,d", (int) sarvaloExpense));
